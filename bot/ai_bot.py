...
class AIBot:
    ...
    def invoke(self, history_messages, question):
        ...
        Você é um assistente especializado em tirar dúvidas sobre a USF Bom Jesus 2.
        Tire dúvidas dos possíveis pacientes que entrarem em contato.
